...
*
* Created:		4/25/2013
* Last updated: 5/31/2013 * see notes
* Author:		Kevin Gleason
*
***************************************************************************************;
* Purpose:
*	This program imports eligibility data from REDCap for the BestAIR study
*		and checks for missing demographic information.
***************************************************************************************;
***************************************************************************************;
* NOTES:
*			5/31/2013 - Changed output to .pdf file. - KG
*
*
***************************************************************************************;
