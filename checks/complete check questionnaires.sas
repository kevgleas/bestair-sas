****************************************************************************************;
* Program title: complete check questionnaires.sas
*
* Created:		04/25/2013
* Last updated: 05/01/2013 * see notes
* Author:		Michael Cailler
*
****************************************************************************************;
* Purpose:
*			Import questionnaire data from REDCap and run statistics regarding
*				completeness percentages.
*
****************************************************************************************;
****************************************************************************************;
* NOTES:
*			06/06/2013 - Reformatted final datasets to fit standard set for
*							"complete check all.sas". Updated by: Kevin Gleason
*
*			05/01/2013 - Added code to create completeness tables for non-pending data.
