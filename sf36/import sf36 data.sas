...
%include "\\rfa01\bwh-sleepepi-bestair\data\SAS\sf36\sf36_macros.sas";
  ...
  data sf36_fix2;
    ...
    * using sf36_index_macro
    ************************************************************************************************;

    *physical functioning index;

    format pf_options 8. sf36_rawpf sf36_pf best12.;
    pf_options = 3;
    array sf36_phys[*] sf36_pf01--sf36_pf10;
    %sf36_index_macro(index_array= sf36_phys, first_var= sf36_pf01, last_var= sf36_pf10, num_options= pf_options, rawindex_score= sf36_rawpf, adjindex_score= sf36_pf);
    drop pf_options;
    ...
    *role-physical index;
    ...
    format rp_options 8. sf36_rawrp sf36_rp best12.;
    rp_options = 5;
    array sf36_rolephys[*] sf36_rp01--sf36_rp04;
    %sf36_index_macro(index_array= sf36_rolephys, first_var= sf36_rp01, last_var= sf36_rp04, num_options= rp_options, rawindex_score= sf36_rawrp, adjindex_score= sf36_rp);
    drop rp_options;
    ...
    *role-emotional index;
    ...
    format re_options 8. sf36_rawre sf36_re best12.;
    re_options = 5;
    array sf36_rolemo[*] sf36_re01--sf36_re03;
    %sf36_index_macro(index_array= sf36_rolemo, first_var= sf36_re01, last_var= sf36_re03, num_options= re_options, rawindex_score= sf36_rawre, adjindex_score= sf36_re);
    drop re_options;
    ******************************************
