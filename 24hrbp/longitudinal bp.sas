****************************************************************************************;
* Program title: longitudinal bp.sas
*
* Created:		6/14/2013
* Last updated: 6/14/2013 * see notes
* Author:		Kevin Gleason
*
****************************************************************************************;
* Purpose:
*			Import 24-hour BP data from REDCap and raw files from rfa server.
*				Plot longitudinal 24-BP data by study participant to test completeness.
*				Report completness of expected longitudinal data by treatment arm
*
****************************************************************************************;
****************************************************************************************;
* NOTES:
...
****************************************************************************************;
	proc sql;
	ods pdf file="\\rfa01\bwh-sleepepi-bestair\Data\SAS\checks\Longitudinal BP by Treatment Arm &sasfiledate..PDF";
